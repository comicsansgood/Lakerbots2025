...
//2023
        ...
        swerveOdometry = new SwerveDriveOdometry(Constants.swerveKinematics, getState().Pose.getRotation(), getModulePositions());
    ...
    public void periodic() {
        ...
        /*$$$$$$$ removed this cause we are no longer an AK swerve project
        ...
        rawGyroRotation = getState().Pose.getRotation();
    ...
    private SwerveModulePosition[] getModulePositions() {
        ...
        for (int i = 0; i < 4; i++) {
          states[i] = getState().ModulePositions[i];  
        }
        return states;
      }
